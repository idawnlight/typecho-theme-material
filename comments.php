...
<?php if ($this->options->commentis == '0' || (getThemeOptions('SwitchToDisqusSince') == '0' || getThemeOptions('SwitchToDisqusSince') == '' || getThemeOptions('SwitchToDisqusSince') == null || $this->cid < (int)getThemeOptions('SwitchToDisqusSince'))): ?>
    <!-- 使用原生评论 -->
