        ...
        <div class="material-index mdl-grid">
            ...
            <?php else: ?>
                ...
                <div class="post_entry-module mdl-card mdl-shadow--<?php $this->options->CardElevation() ?>dp mdl-cell mdl-cell--12-col <?php if (!empty($this->options->switch) && in_array('ShowLoadingLine', $this->options->switch)): ?>fade out<?php endif; ?>">
                    ...
                    <!-- Article link & title -->
                    <div class="post-thumbnail-pure mdl-card__media mdl-color-text--grey-50 lazy " data-original="<?php thisThemeFile("img/daily_pic.png"); ?>">
                        <p class="article-headline-p"><a href="<?php $this->options->siteUrl() ?>" target="_self"><?php $this->options->title() ?></a></p>
                    </div>
                    ...
                    <div class="mdl-color-text--grey-600 mdl-card__supporting-text post_entry-content">
                        <span>
                            <?php echo tranMsg("Could not find related articles", "未能找到相关文章", $this->options->langis) ?>&nbsp;&nbsp;&nbsp;
                            <a href="<?php $this->options->siteUrl(); ?>" target="_self"><?php echo tranMsg("Return to homepage", "回到主页", $this->options->langis) ?></a>
                        </span>
                    </div>
